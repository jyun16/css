var SelectPure = function () {
    ...
    class e {
        constructor(t, e = {}, s = {}) {
            return this._node = t instanceof HTMLElement
                ? t
        ...
        append(t) {
            return this._node.appendChild(t),
            this
        }
        addClass(t) {
            return this
    ...
    return class {
        ...
        _create(t) {
            ...
            this._optionsWrapper = new e("div", {class: "select-pure__options"}),
        ...
        _generateOptions() {
            return this._config.autocomplete && (this._autocomplete = new e("input", {
                ...
                type: "text"
            }), this._autocomplete.addEventListener("input", this._boundSortOptions), this._optionsWrapper.append(this._autocomplete.get())),
            this
                ._config
                .options
                .map(t => {
        ...
        _handleClick(t) {
						const cname = t.target.className
            if (t.stopPropagation(), "select-pure__autocomplete" !== cname) {
                if (this._state.opened) {
                    ...
                    void(this._state.opened = !1)
								...
								if (cname == 'select-pure__close') { return }
                cname !== this._config.icon && (this._select.addClass("select-pure__select--opened"), this._body.addEventListener("click", this._boundHandleClick), this._select.removeEventListener("click", this._boundHandleClick), this._state.opened =! 0, this._autocomplete && this._autocomplete.focus())
            }
        }
        _setValue(t, e, s) {
            if (t && ! s && (
                this._config.value = this._config.multiple
                    ? this
                        ...
                        .concat(t)
                    : t
            ), t && s && (this._config.value = t), this._options.forEach(t => {
                ...
                const t = this
                    ...
                    .map(t => {
                        ...
                        return this
                            ._options
                            .find(t => t.get().getAttribute("data-value") === e.value)
            ...
            const i = this._config.value
                ? this
                    ._config
                    .options
                    .find(t => t.value === this._config.value)
                : this._config.options[0];
            this
                ._options
                .find(t => t.get().getAttribute("data-value") === i.value)
                .addClass("select-pure__option--selected"),
        ...
        _selectOptions(t, s) {
            ...
            s && this._optionsWrapper.setTop(Number(this
                ._select
                .getHeight()
                .split("px")[0]) + 5)
        }
